...
SECTION_URL = "https://news.naver.com/breakingnews/section/104"  # 세계
MAX_ARTICLES = 10
OUTPUT_PREFIX = "world"
...
def fetch_world_headlines(url, max_articles=10):
...
def main():
    print("세계 뉴스를 가져오는 중...")
    articles = fetch_world_headlines(SECTION_URL, MAX_ARTICLES)
